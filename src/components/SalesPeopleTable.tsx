...
const SalesPeopleTable = ({inputDataTable}) => {
  ...
  const isSalesPersonSelected = (salesPerson: SalesPerson) =>
    (selectedStatusM.includes(salesPerson.status) || selectedStatusM.length === 0);
  ...
  return (
    <>
      ...
      <div className="flex space-x-2">
        ...
        >
          <MultiSelectItem value="overperforming">Overperforming</MultiSelectItem>
          <MultiSelectItem value="average">Average</MultiSelectItem>
          <MultiSelectItem value="underperforming">Underperforming</MultiSelectItem>
        </MultiSelect>
      </div>
