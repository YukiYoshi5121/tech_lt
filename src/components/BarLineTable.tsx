...
const get_gdata = (filedata:string[][], groups:string[], subgroups:string[]) => {
...
// Table
const get_tdata = (filedata:string[][], groups:string[], subgroups:string[]) => {
...
const Graph = () => {
  ...
  */
  ...
  return (
    <>
      <Card className="max-w-7xl mx-auto mt-4 mb-6 bg-blue-100" decoration="top" decorationColor="indigo">
